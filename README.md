...
• Click "Select" to choose the AMI. ->Choose an Instance Type: 
...
• Click "Next: Add Tags". ->Add Tags (Optional): 
• Add tags to your instance for easier identification and management. 
• Click "Next: Configure Security Group". ->Configure Security Group: 
